...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/adressBook.js");
/******/ })
/************************************************************************/
/******/ ({
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // "1) Stwórz strukturę danych związaną z książką adresową.
...
var Validator = function () {
    ...
    _createClass(Validator, null, [{
        key: 'isEmptyString',
        value: function isEmptyString(stringLikeValue) {
            var notaString = typeof stringLikeValue !== 'string';
            var lengthIsNotZero = stringLikeValue.length !== 0;

            var cond = notaString || lengthIsNotZero;
            if (!cond) throw new Error('Params must be string');
        }
    }, {
        key: 'isWrongEmail',
        value: function isWrongEmail(email) {
        ...
        key: 'isContact',
        value: function isContact(value) {
            return value instanceof Contact;
        }
    }, {
        key: 'isGroupContact',
        value: function isGroupContact(value) {
...
var GroupContact = function () {
    function GroupContact(nameGroup) {
        _classCallCheck(this, GroupContact);
    ...
    _createClass(GroupContact, [{
        ...
        key: 'changeNameGroup',
        value: function changeNameGroup(nameGroup) {
            Validator.isEmptyString(nameGroup);
...
var contact = new Contact('Piotr', "J", 'p.j@gmail.com');
